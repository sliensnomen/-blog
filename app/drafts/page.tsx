...
import { AlertTriangle, Search, Trash2, X, Sparkles, Pencil, Smile, User } from 'lucide-react';
      ...
      <PageTransition>
        <main className="w-[90%] max-w-5xl mx-auto mt-28 relative z-10">
          ...
          <div className="mb-8 flex gap-4 flex-wrap">
            ...
            <Link href="/editor?id=new&type=moment" className="px-6 py-3 bg-emerald-500 hover:bg-emerald-600 text-white rounded-2xl font-black text-sm shadow-lg shadow-emerald-500/30 transition-all active:scale-95 flex items-center gap-2">
              <Smile size={16} /> 发一条说说
            </Link>
            <Link href="/editor?type=about" className="px-6 py-3 bg-amber-500 hover:bg-amber-600 text-white rounded-2xl font-black text-sm shadow-lg shadow-amber-500/30 transition-all active:scale-95 flex items-center gap-2">
              <User size={16} /> 编辑关于我
            </Link>
          </div>
